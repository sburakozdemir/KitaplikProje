...
namespace Kitaplık_Proje
{
    public partial class Form1 : Form
    {
        ...
        OleDbConnection baglanti = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\Burak\Desktop\access\Kitaplık.mdb");
        ...
        {
            baglanti.Open();
            OleDbCommand komut = new OleDbCommand("update kitaplar set Kitapad=@p1,Yazar=@p2,Tur=@p3,Sayfa=@p4,Durum=@p5 where Kitapİd=@p6",baglanti);
...
// Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\Burak\Desktop\access\Kitaplık.mdb